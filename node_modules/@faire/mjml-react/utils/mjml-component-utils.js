...
function convertPropsToMjmlAttributes(props) {
    const mjmlProps = Object.entries(props).reduce((mjmlProps, [prop, value]) => {
        const mjmlProp = prop === DANGEROUSLY_SET_INNER_HTML ? prop : (0, lodash_kebabcase_1.default)(prop);
...
exports.convertPropsToMjmlAttributes = convertPropsToMjmlAttributes;
