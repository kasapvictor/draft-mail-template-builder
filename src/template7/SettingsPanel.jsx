...
// TODO
//  переключение экранов с 600 на 300
//  добавить смену позиции секций
//  создать структуру реального шаблона
//  сделать выгрузку в шаблона в html для тестов
//  при клике на canvas должны открываться настройки всего шаблона
